...
async def main():
    sites = [
        # SiteConfig  (
        #     name="veeam",
        #     url="https://www.veeam.com/blog/?ad=menu-resources",
        #     domain="veeam.com",
        #     base_selector="article.post-preview",
        #     title_selector="a",
        #     url_selector="a",
        #     output_filename="veeam_news.json"
        # ),
        # SiteConfig (
        #     name="broadcom",
        #     url="https://news.broadcom.com/category/news",
        #     domain="broadcom.com",
        #     base_selector="article",
        #     title_selector="a",
        #     url_selector="a",
        #     output_filename="broadcom_news.json"
        # ),
        # SiteConfig(
        #     name="Daily Mirror",
